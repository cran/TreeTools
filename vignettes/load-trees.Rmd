...
Trees saved using [TNT](http://www.lillo.org.ar/phylogeny/tnt/) can be opened in
R using `TreeTools::ReadTntTree`.
...
- Conduct parsimony search using Brazeau, Guillerme & Smith's [approach to inapplicable data](https://ms609.github.io/TreeSearch/articles/inapplicable.html), or using [Profile parsimony](https://ms609.github.io/TreeSearch/articles/profile.html).
