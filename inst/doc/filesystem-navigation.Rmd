...
vignette: >
  %\VignetteIndexEntry{Navigating the file system in R}
...
(You can [do this using the  Graphical User Interface ](https://dss.princeton.edu/training/RStudio101.pdf) in RStudio).
